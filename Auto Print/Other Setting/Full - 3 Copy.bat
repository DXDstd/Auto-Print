...
for  %%i in (*.pdf) do (
@echo        - Dang in %%i...
pdfprint  -printer "%printername%" -chgbin %bin2selected% -firstpage 1 -lastpage 1 -duplex 1 -copies 3 -collate 1 -quiet  "%%i"
)
@echo.
@echo.
...
for  %%i in (*.pdf) do (
@echo        - Dang in %%i...
pdfprint  -printer "%printername%" -chgbin %bin2selected% -firstpage 2 -lastpage -1 -duplex 1 -copies 3 -collate 1 -quiet  "%%i"
)
